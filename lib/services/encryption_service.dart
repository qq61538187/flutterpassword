...
class EncryptionService {
  ...
  Map<String, dynamic> decrypt(String encryptedData, String password) {
    ...
    throw Exception(
        '无效的加密数据格式: 部分数量=${parts.length}，期望格式: v2:pbkdf2:salt:iv:encrypted');
  }

  /// 解密 v2 版本（PBKDF2）
  Map<String, dynamic> _decryptV2(String saltBase64, String ivBase64,
      String encryptedBase64, String password) {
